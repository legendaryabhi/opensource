...
The **SmilingRobo Open-Source Sprint** is a program that allows people to contribute to open-source projects and earn rewards
...
<TestimonialGrid title="Updates">
  ...
  <Testimonial
    ...
    cite="https://twitter.com/@smilingrobo"
  >
    real-to-sim-to-real library now can be used to train robot
  </Testimonial>
