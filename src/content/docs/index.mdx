...
hero:
  ...
  actions:
    - text: Start Contributing
      ...
      icon: right-arrow
      variant: primary
    - text: Interested, but Guide Me
      link: https://forms.gle/tzsXEeq93g3mpEjs7
      icon: external
---
...
<div style={{ display: 'flex', flexDirection: 'row', gap: '10px', Color: 'blue' }}>
  <LinkButton href="https://github.com/orgs/SmilingRobo/discussions">Join Discussion</LinkButton>
  <LinkButton href="https://github.com/SmilingRobo/">Visit Github</LinkButton>
...
<Testimonial
  ...
  >
    ...
    Created Guide for Contributing to open-source-robotics in sprint.
  </Testimonial>
<Testimonial
    name="SmilingRobo"
    handle="smilingrobo"
